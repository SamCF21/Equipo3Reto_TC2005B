...
SELECT * FROM vg_db.User;
SELECT * FROM vg_db.Session;
SELECT * FROM vg_db.Personalization;
SELECT * FROM vg_db.Skilltree;
SELECT * FROM vg_db.Ally;
SELECT * FROM vg_db.Foodtruck;
SELECT * FROM vg_db.LevelScore;
